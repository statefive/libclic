 ...
 * more than once - so a description cannot be defined twice, for example. In
 ...
 *
 * <p>
 * ... When parsed by the {@link Clc} with the value {@code --file datafile.txt}
 * would update all registered {@link OptionListener}s via
 ...
 * {@code datafile.txt}.
 */
public class OptionConfiguration extends AbstractConfiguration {
    ...
    /**
     * Determine if arguments need to be parsed after switches have been
     * processed.
     */
    private Boolean ignoreCliArgs;

    /**
     * The default value of the (value) type; may be {@code null}.
     */
     ...
     *
     * @return {@code true} if the option takes an argument, {@code false} if it
     * doesn't; {@code null} if the argument has never been set.
     */
    ...
    /**
     * Determine if CLI arguments should be ignored when parsing data.
     *
     * @return {@code true} to ignore arguments, {@code false} to include them,
     * {@code null} if the value has never been set.
     */
    public Boolean isIgnoreCliArgs() {
        return ignoreCliArgs;
    }

    /**
     * Set whether or not the option requires CLI arguments to be processed.
     *
     * @param ignoreCliArgs {@code true} to ignore CLI argument processing,
     * {@code false} otherwise.
     */
    public void setIgnoreCliArgs(boolean ignoreCliArgs) {
        this.ignoreCliArgs = ignoreCliArgs;
    }

    /**
     * Get the default value of the type.
     *
     * @return the type default value; may be {@code null}.
     */
    ...
    /**
     * Set the default value for the option configuration.
     *
